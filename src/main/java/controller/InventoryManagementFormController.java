...
public class InventoryManagementFormController {
    ...
    @FXML
    private JFXComboBox<String> itemTypeComBox;

    @FXML
    private TextField qtyTxt;

    @FXML
    private JFXComboBox<String> statusCombBox;
    ...
    private void setData(TreeItem<ItemTm> newValue) {
        if (newValue != null) {
            ...
            itemTypeComBox.setValue(selectedItem.getCategory());
            statusCombBox.setValue(selectedItem.getStatus());
